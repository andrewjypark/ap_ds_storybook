import{R as e}from"./iframe-BwQIFLJj.js";const u=[{key:"small",label:"Small"},{key:"medium",label:"Medium"},{key:"large",label:"Large"}],r={size:n=>`--ap-icon-size-${n}`},d=e.forwardRef(function({icon:o,size:a="medium",className:i,style:l,"aria-label":t,...c},h){if(!o)return null;const s=!t;return e.createElement("span",{ref:h,className:i?`ap-icon ${i}`:"ap-icon",style:{width:`var(${r.size(a)})`,height:`var(${r.size(a)})`,...l},role:s?void 0:"img","aria-label":t,"aria-hidden":s||void 0,...c},e.createElement(o,{"aria-hidden":"true",focusable:"false"}))});d.__docgenInfo={description:`Shared, token-sized icon wrapper. This is the ONE place in the project
