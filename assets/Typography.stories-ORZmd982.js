import{R as e}from"./iframe-CpHF14hN.js";import{F as N,a as z,b as x,L as B}from"./FontFamilyScale-Ddg09Yax.js";import{m as O}from"./Typography-CdoigpYQ.js";import{u as H}from"./useLiveCssValue-BMfFmyhf.js";import"./preload-helper-Dp1pzeXC.js";const C=["ABCDEFGHIJKLMNOPQRSTUVWXYZ","abcdefghijklmnopqrstuvwxyz","0123456789"],I="--ap-font-families-font1",M="16px";function w({label:t,cssVar:i}){const[_,T]=H(i);return e.createElement("div",{className:"ap-type-token-swatch",ref:_},e.createElement("div",{className:"ap-token-key","data-theme":"storybook_ds","data-viewport":"desktop"},t),e.createElement("div",{className:"ap-token-value","data-theme":"storybook_ds","data-viewport":"desktop"},T||"…"),e.createElement("div",{className:"ap-type-token-var","data-theme":"storybook_ds","data-viewport":"desktop"},i),e.createElement("div",{className:"ap-type-token-sample",style:{fontFamily:`var(${I}), sans-serif`,fontSize:M,letterSpacing:`var(${i})`}},C.map(c=>e.createElement("div",{key:c},c))))}w.__docgenInfo={description:`One Letter Spacing card, styled to match Foundations/Border's cards
