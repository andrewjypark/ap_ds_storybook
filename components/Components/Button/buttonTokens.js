...
export const buttonVar = {
	...
	// Already generated by build-tokens.js (tier_3/buttons set) but not
	// wired to any component until now -- see Button.jsx's new
	// .ap-button-text-container, which needs its own fixed height
	// independent from the button's own outer padding (matches the real
	// Figma component's "button_text_container" layer -- see the project
	// doc's button layer-structure audit, 2026-09-15).
	textContainerHeight: (size) => `--ap-button-size-${size}-text-container-height`,
};
